<template>
  <div class="container mb-6 pb-6 imn_blurb_container" id="ordernow">
    <div class="columns">
      <div class="column">
        <h2 class="is-size-1 has-text-centered has-text-weight-bold">
          Order Book Today
        </h2>
        ...
        <div class="columns mt-6 imn_payment_wrap">
          ...
          <div class="column">
            <img src="~/static/img/payment/QRIS.webp" />
          </div>
          <div class="column">
            <img src="~/static/img/payment/Bankpermata.jpg" />
          </div>
          <div class="column">
        ...
        <div class="columns imn_payment_wrap">
          ...
          <div class="column">
            <img src="~/static/img/payment/Shopeepay.webp" />
          </div>
          <div class="column">
